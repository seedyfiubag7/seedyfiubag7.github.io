...
* Finalmente, seleccione Registrarse. Usted será redirigido a la página de inicio, para futuros ingresos referirse a la siguiente sección.
...
* Si un proyecto llama su atención puede tocar en cualquier parte de la tarjeta para inspeccionarlo en detalle. Las características de los proyectos se discuten en secciones siguientes.
...
* Se informará la cantidad aportada. Si el proyecto se encuentra próximo a su financiamiento total, puede que acabe aportando menos de lo esperado

   

<center><img src="um_img/20.png" width="350"/></center>

* Puede consultar un historial de patrocinios en la segunda pestaña de la sección de proyectos.
...
* Luego, elija la ubicación en donde se llevará a cabo su proyecto. Es importante que seleccione una de las opciones provistas, no se aceptan ubicaciones personalizadas.
...
* Los proyectos recién creados no figuran en búsquedas normales, en cambio se listan en una sección especial con símbolo de ojo en la pestaña de proyectos. Alternativamente puede visitar dicha sección dirigiéndose a Cuenta y presionando el botón que utilizó inicialmente para aplicar para veedor.

   <center><img src="um_img/40.png" width="350"/></center>

* La sección de veeduría se divide en dos pestañas: La pestaña izquierda contiene un listado de los proyectos que ha supervisado, mientras que  la pestaña derecha contiene un listado de los proyectos que buscan veedores.

   

* Navegue hacia el proyecto deseado tal y como se describe en el apartado de exploración de proyectos.
...
* Puede volver a seleccionar la campañita para dejar de recibir notificaciones.
